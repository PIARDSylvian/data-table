...
const changeFilter = (newFilter: string) => {filter = newFilter}

describe('Header integration test', () => {
  it('should by render with column ["first", "second"]', () => {
    render(<table><Head columns={['first', 'second']} filter={{filter:'first',order:''}} changeFilter={changeFilter} /></table>)
  ...
  it('should by render with column ["first", "second"]', () => {
    render(<table><Head columns={['first', 'second']} filter={{filter:'first',order:''}} changeFilter={changeFilter} options={[null, 'renamed-second']}/></table>)
